...
function render(d){
  ...
  const b=d.broker||{};setText('brokerStage',String(b.broker_stage||'pending').replaceAll('_',' '));setText('brokerProgress',`${Number(b.broker_progress||0).toFixed(2)}%`);setText('brokerConditions',num(b.broker_conditions));setText('brokerAnchors',num(b.broker_anchor_survivors));setText('brokerRaw95',num(b.broker_raw95_survivors));setText('brokerFinal98',num(b.broker_exact98_finalists));setText('brokerHealth',b.broker_health||'WAITING');setText('brokerError',`${b.broker_health||'WAITING'} / ${num(b.broker_error_bytes||0)} B`);
